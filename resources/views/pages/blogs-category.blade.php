    ...
    <section class="blogs-main-section">
        ...
        <div class="container position-relative z-1" data-aos="fade-left">
            ...
            <p class="text-center mt-4">
                Showing blogs under <strong>{{ $category }}</strong> category
            </p>
        </div>
        ...
        <div class="container py-5">
            <div class="row g-4">
                        ...
                        <div class="card custom-blog-card h-100 shadow-sm border-0"
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <a href="{{ route('blogs.details', $blog['id']) }}"
                                    class="btn btn-link px-0 text-decoration-none text-teal mt-auto align-self-start">
                                    View Post
                                </a>
                            </div>
                        </div>
                ...
                @empty
                    <div class="col-12">
                        <p class="text-center mt-4">No blogs found in this category.</p>
                    </div>
                @endforelse
            </div>
        </div>
