@if (!empty($learn_videos))
    <section class="build" data-aos="fade-left">
        ...
        <div class="container py-5">
            ...
            <div class="text-center mt-5" data-aos="fade-up">
                <a href="{{ url('/learn') }}" class="view-all btn btn-outline-dark px-4 py-2">
                    View All
                </a>
            </div>
        </div>
        ...
        <!-- Modals -->
        @foreach ($learn_videos as $index => $video)
            <div class="modal fade" id="videoModalHome{{ $index }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content bg-black">
                        <div class="modal-body p-0 position-relative">
                            <button type="button" class="btn-close position-absolute top-0 end-0 m-3"
                                data-bs-dismiss="modal" aria-label="Close" style="z-index: 9999;"></button>
                            <video id="popupVideoHome{{ $index }}" controls autoplay muted class="w-100"
